...
namespace Buddy.Database.Test
{
  public class DbScriptTest
  {
    ...
    [TestCase(DbScripts.AbsoluteFileSchema, ScriptType.File, "C:\\Users\\chogan\\Dropbox\\DevP\\Buddy.Database\\src\\Buddy.Database.Test\\Resources\\schema.txt")]
    [TestCase(DbScripts.ResourceSchema, ScriptType.Resource, "Buddy.Database.Test.Resources.schema.txt")]
    [TestCase(DbScripts.RelativeFileSeed, ScriptType.File, "..\\..\\Resources\\seed.txt")]
    [TestCase(DbScripts.AbsoluteFileSeed, ScriptType.File, "C:\\Users\\chogan\\Dropbox\\DevP\\Buddy.Database\\src\\Buddy.Database.Test\\Resources\\seed.txt")]
    [TestCase(DbScripts.ResourceSeed, ScriptType.Resource, "Buddy.Database.Test.Resources.seed.txt")]
    ...
    [TestCase(DbScripts.RunnableSchema, ScriptType.Runnable, "Buddy.Database.Test.Runnable, Buddy.Database.Test")]
    [TestCase(DbScripts.RunnableSeed, ScriptType.Runnable, "Buddy.Database.Test.Runnable, Buddy.Database.Test")]
