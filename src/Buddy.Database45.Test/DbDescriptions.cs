namespace Buddy.Database.Test
{
  public static class DbDescriptions
  {
    ...
    public const string ExplicitDbDescriptionType = 
      "<DbDescription type=\"Buddy.Database.Test.TestDbDescription, Buddy.Database.Test\">" +
        "<Connection>" +
          "<ConnectionStringName>Valid</ConnectionStringName>" +
        "</Connection>" +
      "</DbDescription>";
    ...
    public const string SingleFileSchema = "<DbDescription>" +
                                           "<Schema type=\"File\">d:\\DevP\\Buddy.Database\\src\\Buddy.Database.Test\\Resources\\schema.txt</Schema>" +
                                           "</DbDescription>";

    public const string SingleResourceSchema = "<DbDescription>" +
                                               "<Schema type=\"Resource\">Buddy.Database.Test.Resources.schema.txt</Schema>" +
                                               "</DbDescription>";

    public const string SingleFileSeed = "<DbDescription>" +
                                         "<Seed type=\"File\">d:\\DevP\\Buddy.Database\\src\\Buddy.Database.Test\\Resources\\seed.txt</Seed>" +
                                         "</DbDescription>";

    public const string SingleResourceSeed = "<DbDescription>" +
                                             "<Seed type=\"Resource\">Buddy.Database.Test.Resources.seed.txt</Seed>" +
                                             "</DbDescription>";
