namespace Buddy.Database.Test
{
  public static class DbScripts
  {
    ...
    public const string RunnableSchema = "<Schema type=\"Runnable\">Buddy.Database.Test.Runnable, Buddy.Database.Test</Schema>";
    public const string RunnableSeed = "<Seed type=\"Runnable\">Buddy.Database.Test.Runnable, Buddy.Database.Test</Seed>";



    public const string RunnableWithMissingClass = "<Schema type=\"Runnable\">Buddy.Database.Test.RunnableWithMissingClass, Buddy.Database.Test</Schema>";
    public const string RunnableWithInvalidMethodName = "<Schema type=\"Runnable\">Buddy.Database.Test.RunnableWithInvalidMethodName, Buddy.Database.Test</Schema>";
    public const string RunnableWithInvalidReturnType = "<Schema type=\"Runnable\">Buddy.Database.Test.RunnableWithInvalidReturnType, Buddy.Database.Test</Schema>";
    public const string RunnableWithInvalidMethodSignature = "<Schema type=\"Runnable\">Buddy.Database.Test.RunnableWithInvalidMethodSignature, Buddy.Database.Test</Schema>";
  }
}